...
首页背景由 `src/components/LandingExperience.astro` 统一管理，候选项为当前图片、工作室视频、60fps 单色粒子曲面视频和黑白雨面视频。
...
- 固定预览入口为 `/video-preview/`、`/video-preview-2/` 和 `/video-preview-3/`，三个视频方案均已加入首页随机池。
